        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            {imagePreview || (!removedCurrentImage && currentImageUrl) ? (
                                ...
                                <input
                                    ...
                                    className="block w-full text-sm text-gray-500
                                        ...
                                        file:bg-main file:text-foreground
                ...
                <Button
                    type="submit"
                    disabled={isPending}
                    className="w-full bg-gradient-to-r from-lime-400 to-lime-600 font-medium py-2 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2"
                >
                    {isPending ? (
                        <>
