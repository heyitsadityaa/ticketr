...
export default function SellerEventList() {
    ...
    return (
        <div className="mx-auto space-y-8">
            ...
            {pastEvents.length > 0 && (
                <div>
                    <h2 className="text-2xl font-bold text-foreground/90 mb-4">Past Events</h2>
                    <div className="grid grid-cols-1 gap-6">
...
function SellerEventCard({
    ...
    return (
        <div
            className={`rounded-lg shadow-sm border ${event.is_cancelled ? "border-red-500" : "border-foreground/20"} overflow-hidden`}
        >
            <div className="p-6">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-4">
                            <div>
                                ...
                                <p className="mt-1 text-foreground/50">{event.description}</p>
                                {event.is_cancelled && (
                        ...
                        <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="border-foreground/20 border p-3 rounded-lg">
