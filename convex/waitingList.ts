...
export async function processQueueHelper(ctx: MutationCtx, { eventId }: { eventId: Id<"events"> }) {
...
export const expireOffer = internalMutation({
    ...
    handler: async (ctx, { waitingListId, eventId }) => {
        ...
        // TODO: Process queue to offer ticket to next person when current ticket expires.
        await processQueueHelper(ctx, { eventId });
    },
});